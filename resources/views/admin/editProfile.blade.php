    ...
    <div class="flex-1 flex flex-col w-full">
        ...
        <main class="flex-1 p-6 " id="main-content">
            <div class="w-full">
                ...
                <form action="" method="POST" class="grid gap-6 shadow-xl rounded-xl">
                    {{-- name section --}}
                    @csrf
                    <div class="shadow-sm rounded-xl p-8">
                        ...
                        <div class="grid grid-cols-1 max-w-xl gap-6 pt-5 ">
                            <div class="flex gap-4 justify-start items-center">
                                ...
                                <input type="text"  value="{{auth()->user()->username}}" class="border-2 border-slate-400  rounded-lg shadow lg:px-10 px-4 py-3 text-left text-md w-full">
                            </div>
                            <div class="flex gap-4 justify-start items-center">
                                <label for="" class="">Email:</label>
                                <input type="text"  value="{{auth()->user()->email}}" class=" border-2 border-slate-400 rounded-lg shadow lg:px-10 px-4 py-3 text-left text-md w-full">
                            </div>
                        </div>  
                    </div>
