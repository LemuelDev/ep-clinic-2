            ...
            <div class="mx-auto max-w-[1500px] px-4 pt-10">
                ...
                <form action="{{ route('patient.store') }}" id="new-patient-form" method="POST" class="grid justify-center shadow-xl rounded-lg lg:px-8 px-4 items-start lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 max-w-[1000px] mx-auto py-7">
                    ...
                    <div class="grid">
                        ...
                        <select name="treatment_choice" class="px-6 py-3 rounded-md shadow-md bg-transparent border w-full border-gray-500">
              ...
              >
                ...
                @endif
                      ...
                      @if (session()->has('throttle_error'))
                      <dialog id="my_modal_24" class="modal">
                        <div class="modal-box">
                          <h3 class="text-xl font-bold">Failed!</h3>
                          <p class="py-4 pt-8 text-center text-red-600">{{session('throttle_error')}}</p>
                          <div class="modal-action">
                            <form method="dialog">
                              <!-- if there is a button in form, it will close the modal -->
                              <button class="btn">Close</button>
